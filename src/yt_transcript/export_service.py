...
class ExportService:
    ...
    def export_analysis_json(self, analysis_id: int) -> str | None:
        ...
        try:
            ...
            export_data = {
                "metadata": {
                    ...
                    "video_info": {"video_id": analysis.video_id, "video_url": analysis.video_url},
                },
                "content": {
    ...
    def export_analysis_csv(self, analysis_ids: list[int]) -> str | None:
            ...
            for analysis_id in analysis_ids:
                ...
                if analysis:
                    row = [
                        ...
                        (analysis.summary_text or "")[:100] + "..."
                        if analysis.summary_text and len(analysis.summary_text) > 100
                        else analysis.summary_text or "",
    ...
    def create_dashboard_data(self, limit: int = 50) -> dict[str, Any] | None:
        ...
        try:
            ...
            dashboard_data: dict[str, Any] = {
                "summary": {
                    ...
                    "average_complexity": sum([a.complexity_score or 0 for a in analyses])
                    / len(analyses)
                    if analyses
                    else 0,
            ...
            for analysis in analyses:
                if analysis.sentiment_label:
                    sentiment_counts[analysis.sentiment_label] = (
                        sentiment_counts.get(analysis.sentiment_label, 0) + 1
                    )
            ...
            for analysis in analyses:
                if analysis.created_at:
                    ...
                    dashboard_data["trends"]["analyses_per_day"][date_str] = (
                        dashboard_data["trends"]["analyses_per_day"].get(date_str, 0) + 1
                    )
